...
register_all_s3_methods = function() {
  ...
  register_s3_method("dplyr", "filter",        "sentinel_request")
  register_s3_method("dplyr", "filter",            "stac_request")
  register_s3_method("dplyr", "collect",          "odata_request")
  register_s3_method("dplyr", "collect",       "sentinel_request")
  ...
  register_s3_method("dplyr", "select",        "sentinel_request")
  register_s3_method("dplyr", "select",            "stac_request")
  register_s3_method("dplyr", "slice_head",       "odata_request")
  register_s3_method("dplyr", "slice_head",    "sentinel_request")
